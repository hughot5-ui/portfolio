...
const projects: Project[] = [
  ...
  },
  {
    ...
    software: 'Figma',
    images: [
      `${import.meta.env.BASE_URL}work/cardnews/여름1.jpg`,
      `${import.meta.env.BASE_URL}work/cardnews/여름2.jpg`,
      `${import.meta.env.BASE_URL}work/cardnews/여름3.jpg`,
      `${import.meta.env.BASE_URL}work/cardnews/여름4.jpg`,
      `${import.meta.env.BASE_URL}work/cardnews/여름5.jpg`,
      `${import.meta.env.BASE_URL}work/cardnews/여름6.jpg`,
    ],
    accent: '#5aaedc',
  },
  {
    ...
    software: 'AI',
    images: [`${import.meta.env.BASE_URL}work/ai-generated/ChatGPT_Image_2026년_8월_6일_오후_10_07_26 copy copy copy.png`],
    accent: '#10b981',
  },
  {
    id: 18,
    ...
    software: 'Figma',
    images: [
      `${import.meta.env.BASE_URL}work/cardnews/말랑이1.jpg`,
      `${import.meta.env.BASE_URL}work/cardnews/말랑이2.jpg`,
      `${import.meta.env.BASE_URL}work/cardnews/말랑이3.jpg`,
      `${import.meta.env.BASE_URL}work/cardnews/말랑이4.jpg`,
      `${import.meta.env.BASE_URL}work/cardnews/말랑이5.jpg`,
      `${import.meta.env.BASE_URL}work/cardnews/말랑이6.jpg`,
      `${import.meta.env.BASE_URL}work/cardnews/말랑이7.jpg`,
    ],
    accent: '#f5c07a',
  },
];
